...
(function (root) {
  ...
  var ICONS = {
    ...
    // Upload / import — pijl omhoog naar doos
    ...
    // Cycle (intel cycle)
    cycle: '<path d="M21 12a9 9 0 0 1-15.5 6.3"/><path d="M3 12a9 9 0 0 1 15.5-6.3"/><path d="M21 4v5h-5"/><path d="M3 20v-5h5"/>',
    // Fingerprint (IoC)
    ioc: '<path d="M6 12a6 6 0 0 1 12 0v3"/><path d="M9 12a3 3 0 0 1 6 0v6"/><path d="M12 12v9"/><path d="M3 12a9 9 0 0 1 18 0"/>',
    // Flag (TLP)
    flag: '<path d="M4 21V4l8 2 8-2v11l-8 2-8-2"/><path d="M4 21V14"/>',
    // Scale (admiralty / source eval)
    scale: '<path d="M12 3v18"/><path d="M5 7h14"/><path d="M8 7l-3 6h6z"/><path d="M16 7l-3 6h6z"/>',
    // Threat actor
    actor: '<circle cx="9" cy="8" r="3.5"/><path d="M3 21c0-3.5 2.7-6 6-6s6 2.5 6 6"/><path d="M16 7l4 4"/><path d="M20 7l-4 4"/>',
    // Crosshair (ATT&CK)
    attack: '<circle cx="12" cy="12" r="9"/><path d="M12 2v4"/><path d="M12 18v4"/><path d="M2 12h4"/><path d="M18 12h4"/>',
    // Shield-check (D3FEND)
    defend: '<path d="M12 3 4 6v5c0 5 3.5 8.5 8 10 4.5-1.5 8-5 8-10V6l-8-3z"/><path d="m9 12 2 2 4-4"/>',
    // Diamond
    diamond: '<path d="M12 3 3 12l9 9 9-9z"/><path d="M3 12h18"/><path d="M12 3v18"/>',
    // Hunt (binoculars)
    hunt: '<circle cx="6" cy="14" r="4"/><circle cx="18" cy="14" r="4"/><path d="M10 14h4"/><path d="M5 4h4l1 4"/><path d="M19 4h-4l-1 4"/>',
    // Template
    template: '<path d="M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z"/><path d="M14 3v5h5"/><path d="M8 13h8"/><path d="M8 17h6"/>',
    // Glossary (book)
    glossary: '<path d="M4 4h12a2 2 0 0 1 2 2v14H6a2 2 0 0 1-2-2z"/><path d="M4 18a2 2 0 0 1 2-2h12"/>'
  };
